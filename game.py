...
"""This file is garbage. It was a hastily coded mockupo demonstrate how to use the engine.  We will be creating
...
def main():
    ...
    b = league.Tilemap('./background2.py', sprites, layer=0)
